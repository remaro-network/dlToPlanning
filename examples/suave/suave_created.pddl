(define (domain suave)
	...
	(:constants IN_ERROR_NFR_string water_visibility IN_ERROR_FR_string FALSE_string IN_ERROR_COMPONENT_string RECOVERED_string true_boolean INTERNAL_ERROR_string false_boolean)
