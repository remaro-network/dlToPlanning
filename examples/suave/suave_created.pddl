(define (domain suave)
	...
	(:constants IN_ERROR_FR_string IN_ERROR_COMPONENT_string INTERNAL_ERROR_string IN_ERROR_NFR_string water_visibility RECOVERED_string true_boolean FALSE_string false_boolean)
