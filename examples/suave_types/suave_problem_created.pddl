(define (problem example-auv)
  ...
  (:init
    ...
    (lessThan 0.25_decimal 1.5_decimal)
    ...
    (lessThan 0.5_decimal 1.5_decimal)
    ...
    (lessThan 0.75_decimal 1.5_decimal)
    ...
    (PddlType type_function)
    (PddlType type_function_design)
    ...
    (hasPddlType f_follow_pipeline type_function)
    (hasPddlType f_generate_search_path type_function)
    (hasPddlType f_maintain_motion type_function)
    (hasPddlType fd_all_thrusters type_function_design)
    (hasPddlType fd_follow_pipeline type_function_design)
    (hasPddlType fd_recover_thrusters type_function_design)
    (hasPddlType fd_spiral_high type_function_design)
    (hasPddlType fd_spiral_low type_function_design)
    (hasPddlType fd_spiral_medium type_function_design)
    (hasPddlType fd_unground type_function_design)
    ...
    (hasValue qa_performance_zero 0.0_decimal)
    ...
    (pddlName type_function function_string)
    (pddlName type_function_design function-design_string)
